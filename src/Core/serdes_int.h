...
struct serdes_conf_s
{
    ...
    void *opaque;
    /* Log callback */
    void (*log_cb)(serdes_t *serdes, int level, const char *fac,
                   const char *str, void *log_opaque);
};
...
{
    LIST_ENTRY(serdes_schema_s)
    ss_link;                 /* serdes_t.sd_schemas list */
